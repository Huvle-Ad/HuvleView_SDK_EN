...
Currently, the latest version of Huvle SDK is **6.0.3**. Huvle SDK is recommended to apply **TargetSDK 31** or more.
...
dependencies {
	...
	*/
	...
	implementation 'com.byappsoft.sap:HuvleSDK:6.0.3' 
	.
	.
}
```
